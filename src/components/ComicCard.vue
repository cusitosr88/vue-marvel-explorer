...
<template>
  <CardView>
    ...
    <template v-slot:default>
      <img
        class="aspect-[150/228] shadow-xl float-left mr-4" :src="`${comic.thumbnail.path}.${comic.thumbnail.extension}`"
        width="150"
      />
      <dl>
        <dt>Series:</dt>
        ...
        <dd v-if="charactersList.length > 0">{{ lf.format(charactersList) }}</dd>
